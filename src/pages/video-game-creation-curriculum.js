...
const VideoGameCreationCurriculum = () => (
  <Layout>
    <h1>
        2018 Video Game Creation Camp Lesson Plan
    </h1>
    <p>
        Make your own video game! From Pong to Maze games, you&#39;ll learn to code
        then put those skills to use. Using an MIT built platform, you&#39;ll create
        your custom online game to share with friends and family. Please come knowing
        how to navigate the internet (basic typing and mouse control) and a passion
    ...
    <p>
      Lessons
      {' '}
      <OutboundLink href="https://docs.google.com/document/d/1ipDMwBAEmSjZoC6eoJuu-v96SPO5h07YiiYeD6eSlWs/edit">
        Here
      </OutboundLink>
    ...
    <ul>
      ...
      <ul>
        <li>
          Explain to the students that Scratch is a platform built for all ages to use;
          however, we are going to &#34;level it up&#34; for them because they are older
          and can handle the more complex (aka fun) parts of Scratch
        </li>
        <li>Vocab </li>
        <ul>
          <li>
            If-statements - allows the computer to check a condition and decide whether to do
            something, run code if something is true or false
          </li>
          <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            If you dont&#39;t have a set of cards, the prompts
            can be found
            {' '}
        ...
        <ul>
          ...
          <ul>
            ...
            <li>
              “If I go to the movie… I will see Charlie and the Chocolate
              factory.”
            </li>
            <li>
              “If I see Charlie and the Chocolate Factory… I will eat
              lots of chocolate.”
            </li>
        ...
        <ul>
          <li>
            First, this might be a better game to play outside or in an open
            space.
          </li>
          <li>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          ...
          <li>
            Now, go to the dart sprite as we are gonna make the darts scatter
            more.
          </li>
          <li>
    ...
    <ul>
      ...
      <ul>
        ...
        <li>
          When your level increases, the time the boss regenerates increases by 5 times and the next
          boss’s health increases by 2 times its old HP, so it gets harder!
        </li>
        <li>
          You must go to the Dart code, and change it for when you are touching the boss. Dart code:
        </li>
        ...
        <ul>
          ...
          <li>
            Challenge #3: Continue to add admin specialties (better gun?) and add your
            friends as admins!
          </li>
        </ul>
      </ul>
      ...
      <ul>
        ...
        <li>
          If you dont&#39;t have a set of cards, you can find them
          {' '}
...
export default VideoGameCreationCurriculum;
