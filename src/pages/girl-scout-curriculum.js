    ...
    return(
      <div>
        ...
        <ul>
            ...
            <li>Busy Day Activity (15 minutes)- As a busy girl scout, they probably have a long list of 
                ...
                through the problem-solving process in steps.</li>
                <ul>
                    <li>Have scouts write down a list of the things they have to do for the week. 
                        They should keep writing until 5 minutes has passed</li>
                    <li>Then give the girls 3 minutes to prioritize their tasks</li>
                    <li>As a group, discuss the different methods used:</li>
                        <ul><li>How did they break the tasks into groups</li>
                        <li>What patterns did they follow (eg school first, then friends, then chores) </li></ul>
                </ul>
            <li>Relate this back to creating a website: we need to determine all the long list of things 
                to put on our website. Then we chunk them into groups and complete.</li>
            <li>Code time (30 minutes)</li>
            <li>Conditionals Competition (15 minutes)- Split scouts into 2 teams. The person at the 
            ...
            <li>Conditionals Card Game (30 minutes) - Have scouts break into pairs</li>
                <ul>
                    <li>Each pair should get a piece of paper. Tell scouts they have 15 minutes to write 
                        ...
                        track of time (announce every five minutes)</li>
                    <li>Once the paris have completed this, they may have 15 minutes to play another 
                        team's games. If it seems some are boring of this, have them switch again before 
                        the 15 minutes is over</li>
                </ul>
            <li>Break (60 minutes)</li>
                <ul><li>Halfway through</li></ul>
            <li>Just Dance loops activity (30 minutes) - Begin the activity by reminding students that 
            ...
            <li>Pattern Tracking Game (30 minutes) - Have scouts break into 2 teams</li>
                <ul>
                    <li>Set up: Remind scouts that in coding, we look for patterns and repetition to 
                        ...
                        the exact form).</li>
                    <li>Line the teams up. The person in front of each line gets a fly swatter. When 
                        the question is displayed on the board, the first player to hit the correct 
                        answer, scores a point for their team</li>
                    <li>The scout who buzzes in first must explain their answer. If the answer 
            ...
            <li>Make a Picture (30 minutes) - Each student is given a sheet of graph paper and 
                instructions on how to create an image on their graph paper. Give students 10 
                minutes to complete their drawing</li>
                <ul>
                    <li>Instructions found here (Algorithm results in order: monkey, camel, elephant, cat)</li>
                    <li>When students are done, have them compare the image and the original side by side and 
