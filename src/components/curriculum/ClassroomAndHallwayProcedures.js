...
export default () => (
  <div>
    ...
    <p>
Rules we would like them to guess themselves (if not, lead them that direction until
                they can guess)
    ...
    <ul>
      ...
      <li>
          Explain the class structure: Break halfway (Snacks, Bathroom, Outside?)
    ...
    <ul>
      ...
      <li>
We walk together. No one runs ahead in front of the teacher. The teacher is the
