  ...
  render(){
    return(
      <div>
        ...
        <p>Have you heard of Code Thinking? It's the way programmers think! Learn code thinking and the 
          basics of programming using blocks like counters, loops, functions, and variables. Use your 
          new knowledge to solve puzzles on screen with time  away from the screen in fun activities
           to learn concepts like binary and cryptography. Please come knowing how to navigate the 
           internet (basic typing and mouse control) and a passion to work hard and have fun!</p>
            ...
            <li>Harold the Robot Activity  - Randomly layout a collection of plastic or paper 
              ...
              use verbal commands to instruct what the ‘robot’ (either the instructor or another student)
               ...
               instructions the ‘robot’ will follow.  The ‘robot’ is free to decide what instructions
                ...
                visibly show this by shaking their head or slumping there head into their hands.</li>
              <ul><li>Try making a pyramid of 3 cups first and then move on to bigger pyramids</li></ul>
      </ul>
      ...
      <ul>
        ...
        <li>Just Dance loops activity - Begin the activity by reminding students that we see loops 
          ...
          difference between repeat loops and conditional loops. For example, in the songs, we weren't 
        ...
        <ul>
          ...
          <li>A computer program is a group of instructions or a bunch of lines of code that execute 
          a specific task. This could be as simple as calculating a few numbers or could be more complex,
           like building Facebook. Websites, games, and apps are all examples of computer programs.</li>
        </ul>
      <li>Sorting Algorithms - Give the coders eight cards (Ace through 8, out of order). The coders 
      ...
      <li>Have students at least get through the Farmer 2 levels on code.org. Once students finish 
        this set of levels, if students seem to be moving quickly through code.org or seem to be getting
         bored, they seem to like codecombat.com. Have them make an account using the same information as 
         their code.org account in order to save progress.</li>
      ...
      <h2>Day 3</h2>
        <ul>
          ...
          <ul>
            ...
            <li>X = 3 example: This means we have stored the number 3 as “X.” So if we typed in 4 + X, 
              it would equal 7 because X is 3. </li>
          ...
          <li>Binary Numbers - Each student gets 5 cards (Ace, 2, 4, 8, King - the king is a 16). 
            ...
            it is off, it is a zero. With just 5 ones and zeroes, let’s see what kind of numbers we can 
            make. Can you make a 4? Can you make a 0? What is the largest number you can make with these 
            cards? </li>
            <ul><li>Easy way to explain binary: to add 1, starting with Ace, keep flipping cards until
               you flip one face-up.</li></ul>
          <li>Break Time - 15 minutes</li>
            <ul>
          ...
          <li>Binary Competition: The goal of this activity is to allow students to practice converting 
            numbers to binary, with competition as incentive.</li>
            <ul>
              <li>Method 1 (two instructors, one for each team): Make 2 sets of 15 note cards numbered 
                ...
                attempt, the player moves to the back of the line. First team to finish all 15 cards wins. </li>
              <li>Method 2 (one instructor): If there is only one teacher, rather than checking if the 
                ...
                This has the added benefit that the first team to finish won't be sitting around waiting 
                for the other.</li>
        ...
        <ul>
          <li>Teach vocabulary for today:</li>
            <ul><li>Compression: In order to save data, computers try to make objects on them smaller, 
              while still being able to recognize them</li></ul>
          ...
          <li>Stretches</li>
          <li>Computer science fun fact of the day: </li>
            <ul><li>How can high-quality photos, audio, and video be compressed so much (1/10 to 1/100 
              of original size) without losing much quality? (lossy compression algorithms) </li></ul>
          <li>Making an Algorithm- Students should each be given an algorithm to make a folded paper 
      ...
      <p>If students are done with code.org, now is the time to introduce them to other websites. 
