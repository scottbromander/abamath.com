...
const ThreeHourCodeChampionship = () => (
  <Layout>
    <h1>
    ...
    <p>
      Each day consists of multiple guided instruction sections where
      ...
      time to complete their “Final Project”.
    </p>
    ...
    <ul>
      ...
      <ul>
        <li>
          <OutboundLink href="https://scratch.mit.edu/projects/236400359/#editor">Challenge URL</OutboundLink>
          {' '}
        </li>
        <li>
          Sample Player 1 URL:
          {' '}
          <OutboundLink href="https://scratch.mit.edu/projects/235144179/">https://scratch.mit.edu/projects/235144179/ </OutboundLink>
        </li>
        <li>
          Sample Player 2 URL:
          {' '}
          <OutboundLink href="https://scratch.mit.edu/projects/234836062/">https://scratch.mit.edu/projects/234836062/ </OutboundLink>
        </li>
      </ul>
      <li>Create Scratch Accounts - 5 minutes </li>
      <li>
        Guided Instruction -
        Remix base project and create a bot that moves left and down - 5 minutes
      </li>
      <ul>
      ...
      <li>
        Explanation of the Vacuum challenge:
        There are two bots on the screen at a time. Game Rules:
      </li>
      <ul>
      ...
      <li>Stretches</li>
      <li>
Improvement Time - 30 minutes - students may test there bots against others on their computer, or on
                the projector

      </li>
      <li>
Bracket Challenge - For large class, create a single-elimination bracket. For a small class, every
                student will play every other student - 45 minutes
        {' '}

      </li>
      <ul>
        <li>
          Note: Round robin without keeping score keeps things competitive, but not too competitive.
          Round robin with 6 students took 30 minutes.
        </li>
      </ul>
...
export default ThreeHourCodeChampionship;
