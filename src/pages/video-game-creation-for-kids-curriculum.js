...
export default class VideoGameCreationForKidsCurriculum extends React.Component {
  render(){
    return(
        ...
        to use. Using an MIT built platform, you'll create your custom online game to share with 
        friends and family. Please come knowing how to navigate the internet (basic typing and 
        ...
        <p>To be able to define what a video game is: A video game is an electronic game that 
            involves player interaction.</p>


        <h5>Basic Structure</h5>
        <p>Each day consists of multiple guided instruction sections where the coach will lead the 
        ...
        <p>Lessons <OutboundLink href="https://docs.google.com/document/d/19YHoFghCECKPhzRyj6st0liT15j9Ipdy3gWy1a25Klg/edit">
            Here</OutboundLink></p> 
            ...
            <ul>
                ...
                <li>Lesson 1 - Intro to Scratch</li>
                    <ul>
                        ...
                        <li>Show where the duplicate, delete, grow, and shrink buttons are, then delete 
                            the default sprite (cat).</li>
                        ...
                        <ul>
                            ...
                            <li>This is important because when we start a game we don’t always know 
                                what a certain variable is set to, so this allows up to reset it to 
                                the proper value.</li>
                            <li>You may remember that last time we created a moving character, but 
                                there was no way to “restart” the game. This will allow us to do that.</li>
                            <li>Describe how the Green Flag button will be our restart button. It will 
                                run the code below when you start the game.</li>
                            <li>Try having the students drag their character away from their starting 
                                spot and see how each time the program is reset with the flag they are 
                                returned to the proper location.</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>Explain the game as a story of chained events. Here is an example: </li>
                                    <ul>
                                        ...
                                        <li>“If I go to the movie… I will see Charlie and the Chocolate 
                                            factory.”</li>
                                        <li>“If I see Charlie and the Chocolate Factory… I will eat 
                                            lots of chocolate.” </li>
                                        <li>“If I eat lots of chocolate… I will gain weight.” </li>
                                        <li>“If I gain weight… I will have to go to the gym more.” </li>
                                        <li>Etc. </li>
                                    </ul>
                                <li>Start the game with an if statement (If I drink coffee…) and the 
                        ...
                        Active Conditionals Game </OutboundLink></li>
                            <ul>
                                <li>First, this might be a better game to play outside or in an open 
                                    space. </li>
                                <li>For every round, where each person gets 3 statements, there is one 
                                    Programmer and everyone else is a Computer.  The Programmer stands
                                     ...
                                     a circle, Then you turn in a circle.” </li>
                                <li>Moving on up the grade levels, you can move on up the coding 
                    ...
                    <ul>
                        <li>Conditionals</li>
                            <ul>
                                ...
                                <li>Everyone’s game should have at least two sprites (the player sprite 
                                    and the balloon sprite) with only the initialization code (the other 
                                    code should can be deleted from lesson 1).</li>
                                <li>Use conditionals to change how the player moves:</li>
                                <ul><li>While you add the code:</li>
                                    <ul>
                                        <li>Player Code </li>
                        ...
                        <li>How to shoot/battle</li>
                            <ul>
                                <li>You can make a dart by choose a pencil sprite in the library, 
                                    filling it in in the color, and shrinking it very small </li>
                                ...
                                <li>When you make the clone, then describe that you set the dart to 
                                    come from the player sprite. </li>
                                <li>Then, explain that repeat until touching edge will keep moving 
                                    until it hits the edge.</li>
                                <li>Then, you must delete the clone, so your game does not lag 
                                    from too many. </li>
                            </ul>
                        <li>Improvement Time</li>
                ...
                <li>Lesson 3 - Variables and Operators</li>
                    <ul>
                        <li>Score, Timer, Lives</li>
                            <ul><li>Make a variable block in the data section called “HP”, “Lives”, 
                                or “Health”</li>
                            <li>In the player sprite, set your health and change your lives, if 
                                touching balloon.</li></ul>
                        <li>Win Condition/Game Over</li>
                            <ul>
                                <li>Make a “Game Over” screen from the paintbrush under the backdrop 
                                    section.</li>
                                <img src={videogame31} alt="make 'game over' background" height="300"/>
                                <li>If your health gets to 0 or less, switch to the Game over screen,
                                     hide the player, and stop the game.</li>
                                <li>Since you want to start with the backdrop on the original, make 
                                    sure you initialize the backdrop by putting a “switch backdrop 
                                    to” block at the beginning of the code. </li>
                                <li>Player code </li>
                                <img src={videogame32} alt="player code" height="500"/>
                                <li>Also, make sure you initialize the player by adding show when 
                                    flag is clicked.</li>
                                <li>Describe some of the operator blocks</li>
                                <li>Now, go to the dart sprite as we are gonna make the darts scatter 
                                    more.</li>
                                <li>Also, we are going to have the darts disappear when they touch the 
                                    balloon. Dart Code </li>
                                <img src={videogame33} alt="dart code" height="400"/>
                                <li>Now, go to the player sprite, and add a timer code that goes up by 
                                    1 second as the game continues.</li>
                                <li>Player code</li>
        ...
        <h2>Day 3</h2>
            <ul>
                ...
                <li>Stretches</li>
                <li>Computer science fun fact of the day: </li>
                    <ul><li>How is it possible for you and dozens of other people to play online simultaneously 
                        and still have the game feel responsive most of the time? (networking, client-server 
                        architecture)</li></ul>
                <li>Networks game: Have students break into groups of 4, 2 players form a team. 
                    ...
                    the word correct, the other team goes. Lowest score wins.</li>
                    <ul><li>Concept: sometimes your networks lag. This is because the networks 
        ...
        <h2>Day 4</h2>
            <ul>
                ...
                <li>Computer science fun facts of the day: </li>
                    <ul><li>When you type in words on a search engine's web page, how does it give you 
                        back the results so quickly? (search algorithms, parallel computing)</li>
                    <li>How can the retailer accurately predict what other items you might like to buy 
                        based on what you've recently bought? (artificial intelligence, machine learning) </li></ul>
                <li>Parallel Processing Guessing Game - Students play this game as a class. Have the 
                    class line up horizontally across the board. Each round is a 6 letter word of your 
                    choice. Draw 6 dashes on the board where you will fill in the letters </li>
                    <ul>
                        <li>For the first round, go down the line and have each student take a guess at 
                            ...
                            to get the whole word </li>
                        <li>For the second round, play like traditional hangman where the guesses can 
                            apply to any letter in the word. This is the "parallel processing 
                            version" </li>
                        <li>Concept: Explain parallel processing and how it helps us go through 
                            algorithms faster </li>
                    </ul>
                <li>Final Game Work Time</li>
            </ul>
